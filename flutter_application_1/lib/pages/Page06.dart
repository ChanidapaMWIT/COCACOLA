...
class Page06 extends StatefulWidget {
  ...
  @override
  State<Page06> createState() => _MyHomePageState();
}
...
//Step 5
class _MyHomePageState extends State<Page06> {
  ...
  void initState() {
    super.initState();
    dialogs = [
      Dialog('เธอ', 'นี่ก็เย็นมากแล้วแหละ กลับกันเถอะ',
          'assets/character/you/You_idle.png'),
      Dialog('${widget.name}', '(ตอนนี้แหละ จะต้องสารภาพรักกับเธอให้ได้ !)',
          'assets/character/Me_idle.png'),
      Dialog('', '[ในจังหวะที่คุณกำลังจะพูด...]', ''),
      Dialog('', '[ก็มีคนร้ายบุกเข้ามาโจมตี !!!]', ''),
    ];
